...
interface StudentListViewProps {
  ...
  totalModules: number;
  onDeleteStudent?: (studentId: string) => void; // Optional callback
}
               ...
               <table className="w-full text-left">
                  <thead className="bg-slate-50 border-b border-slate-100">
                     <tr>
                        ...
                        <th className="px-6 py-4 text-xs font-bold text-slate-400 uppercase tracking-wider w-1/3">Progress Kurikulum</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                     {students.map((student) => {
                        ...
                        return (
                           <tr key={student.uid} className="hover:bg-blue-50/50 transition-colors group">
                              {/* Kolom Nama */}
                              ...
                              <td className="px-6 py-4">
                                 <div className="flex flex-col items-start gap-1">
                                    <span className="bg-yellow-100 text-yellow-700 px-2.5 py-1 rounded-lg text-xs font-bold border border-yellow-200 shadow-sm">
                                       Lvl {student.level || 1}
                                    </span>
