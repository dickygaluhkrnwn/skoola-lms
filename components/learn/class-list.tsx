...
import { School, ChevronRight, GraduationCap, Zap, Hash } from "lucide-react";
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {classes.map((cls) => (
        <motion.div 
          ...
          className={cn(
            "p-5 border shadow-sm transition-all cursor-pointer group relative overflow-hidden",
            // Styles per Theme
        ...
        >
          ...
          <div className={cn(
            ...
            isKids ? "bg-sky-400" : isSMP ? "bg-violet-600" : isSMA ? "bg-teal-400 opacity-20 blur-xl" : isUni ? "bg-white" : "bg-primary"
          )}/>
          ...
          <div className="flex justify-between items-start mb-3 relative z-10">
            <div className={cn(
              ...
              isUni ? "bg-slate-700 text-white border border-slate-600 rounded-2xl" :
            ...
            <div className="flex flex-col items-end gap-1">
               ...
               {cls.category && (
                  <span className={cn(
                    ...
                    isSMA ? "text-slate-400" : isUni ? "text-slate-500" : "text-muted-foreground opacity-60"
                  )}>
                    {cls.category}
                  </span>
               )}
          ...
          <p className={cn(
            ...
            isSMA ? "text-slate-400 font-medium" : isUni ? "text-slate-400" : "text-muted-foreground"
          )}>
          ...
          <div className={cn(
            ...
            isSMA ? "border-white/5 text-slate-400" : isUni ? "border-slate-700 text-slate-400" : "border-border text-muted-foreground"
          )}>
            <div className="flex items-center gap-2">
              ...
              <span className={cn(
                 ...
                 isSMA && "text-slate-300 font-medium"
              )}>
            ...
            <div className={cn(
               ...
               <span className="font-bold">{isSMA ? "Access" : "Masuk"}</span> <ChevronRight size={16} />
            </div>
          </div>
        </motion.div>
      ))}
